...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    base_price: 90,
    student_price: 180,
    image_url: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
    is_available: true,
    rating: 4.8,
    reviews: 245,
    is_veg: true,
  ...
  },
  {
    ...
    base_price: 70,
    student_price: 80,
    image_url: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
    is_available: true,
    rating: 4.6,
    reviews: 512,
    is_veg: true,
  ...
  },
  {
    ...
    base_price: 80,
    student_price: 60,
    image_url: 'https://images.unsplash.com/photo-1626202473489-325d7429188d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
    is_available: true,
    rating: 4.9,
    reviews: 890,
    is_veg: true,
